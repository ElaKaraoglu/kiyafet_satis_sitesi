...
@section('content')
 ...
 <div class="card">
        ...
        <div class="col-sm-3">
            ...
            <div class="col-sm-3">
                 <a href="{{route('admin.category.edit',['id'=>$data->id])}}"  class="btn btn-block btn-warning " style="width: 1000p;" >Düzenle</a>
          </div>
          <div class="col-sm-3">
                 <a href="{{route('admin.category.destroy',['id'=>$data->id])}}" onclick="return confirm('Bu kategori silinecek!! Silmek istediğinize Emin misiniz?')" class="btn btn-block btn-danger " style="width: 1000p;" >Sil</a>
          </div>
