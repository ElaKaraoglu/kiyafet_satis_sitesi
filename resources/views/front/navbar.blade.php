<div class="container-fluid mb-5">
        <div class="row border-top px-xl-5">
            <div class="col-lg-3 d-none d-lg-block">
                <a   class="btn shadow-none d-flex align-items-center justify-content-between bg-info text-white w-100" data-toggle="collapse" href="#navbar-vertical" style="height: 65px; margin-top: -1px; padding: 0 30px; background-color:blueviolet;">
                    <h6 class="m-0">KATEGORİ</h6>
            ...
            <div class="col-lg-9">
                <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
                    <a href="" class="text-decoration-none d-block d-lg-none">
                        <h1 class="m-0 display-5 font-weight-semi-bold"><span class="text-primary font-weight-bold border px-3 mr-1">MNG</span>SHOPPİNG</h1>
                    </a>
                        ...
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu rounded-0 m-0">
                                    <a href="cart.html" class="dropdown-item">info@gmail.com</a>
                                    <a href="checkout.html" class="dropdown-item">05673570489</a>
                                </div>
                            </div>
                        </div>
...
<div class="w3-dropdown-hover">
      <a href="/user" class="nav-item nav-link">{{$user->name}}</a>
 ...
 <a href="/login" class="nav-item nav-link">GİRİŞ</a>
              ...
              @endif
                            ...
                            <a href="/register" class="nav-item nav-link">KAYIT OL</a>
                        </div>
                    </div>
                </nav>
